...
def sendmail(recipients=(), sender="", subject="No Subject", message="No Message",
		...
		bulk_priority=1, communication=None,read_receipt=None):
	...
	if bulk or as_bulk:
		...
		frappe.email.bulk.send(recipients=recipients, sender=sender,
			...
			send_after=send_after, expose_recipients=expose_recipients, bulk_priority=bulk_priority, communication=communication,read_receipt=read_receipt)
	else:
		import frappe.email
		if as_markdown:
