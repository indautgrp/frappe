...
def send(recipients=None, sender=None, subject=None, message=None, reference_doctype=None,
		...
		expose_recipients=None, send_priority=1, communication=None, read_receipt=None, is_notification=False):
	...
	unsubscribe_method=unsubscribe_method, unsubscribe_params=unsubscribe_params, expose_recipients=expose_recipients, read_receipt=read_receipt, is_notification = is_notification)
